// For converting ROOT to mama so that you can perform the Oslo Method
// Not my own work - from University of Oslo Cyclotron Lab
// github.com/oslocyclotronlab/oslo-method-software/root_mama_scripts/th22mama.C
